    ...
    return (
        <View style={styles.container}>
            <View style={styles.card}>
                ...
                {['Nombre:', 'Apellido paterno:', 'Apellido materno:', 'Teléfono:', 'Correo:'].map((label, index) => (
                        ...
                        <TextInput
                            ...
                            onChangeText={(text) => {
                                switch (index) {
                                    ...
                                    case 1: setLastName(text); break;
                                    case 2: setSecondLastName(text); break;
                                    case 3: setPhone(text); break;
                                    case 4: setEmail(text); break;
                                }
                            }}
                            value={[name, lastName, secondLastName, phone, email][index]}
                        />
                    </View>
                ))}
